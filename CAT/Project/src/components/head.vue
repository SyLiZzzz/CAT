...
<el-container>
  ...
  <el-header class="head" >
    ...
    <div class="entrance fr">
        <el-menu :default-active="active" mode="horizontal" background-color="#f5f5f5" text-color="black" active-text-color="#ff0000" @select="handleSelect">
          <el-menu-item index="1">
            饮品<i class="el-icon-cold-drink el-icon--right"></i>
            </el-menu-item>
          ...
          <el-menu-item index="3"><i class="el-icon-shopping-cart-2"></i>购物车</el-menu-item>
          <el-menu-item index="4"><i class="el-icon-refresh-left"></i>退出登录</el-menu-item>
        </el-menu>
        <!-- 修改信息模态框-->
