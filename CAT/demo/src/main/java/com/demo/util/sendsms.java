...
public class sendsms {
	...
	public static String SMS(String phone) throws HttpException, IOException{
		...
		NameValuePair[] data = {//提交短信
				new NameValuePair("account", "C94863650"), //查看用户名是登录用户中心->验证码短信->产品总览->APIID
				new NameValuePair("password", "27d92374d1a73bef51a8efb8ca5d6c31"),  //查看密码请登录用户中心->验证码短信->产品总览->APIKEY
